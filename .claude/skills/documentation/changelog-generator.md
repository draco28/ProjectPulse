...
# Changelog Generator for ProjectPulse
...
All notable changes to ProjectPulse will be documented in this file.
...
[Unreleased]: https://github.com/user/projectpulse/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/user/projectpulse/releases/tag/v1.0.0
```
...
function generateChangelog(since: string) {
  ...
  const commits = log.split('\n').map(parseCommit).filter(Boolean) as Commit[];
...
````markdown
# ProjectPulse v1.1.0 - "Enhanced Search"
