...
Remember: You are implementing for **ProjectPulse** specifically. Reference the docs when making decisions, follow established patterns, and keep code clean, typed, and tested.
