...
const questions: QuestionData[] = [
  ...
  },
  {
    ...
    placeholder: 'e.g., Ages 25-45, work remotely, struggle with manual task tracking and context switching',
    validationType: 'text',
    minLength: 20,
    maxLength: 1000
  },
  {
    ...
    placeholder: 'e.g., Save 10+ hours per week on manual tracking, achieve 80% task completion rate',
    validationType: 'text',
    minLength: 10,
    maxLength: 500
  },
  ...
  // 1.2 Core Features & Scope (3 questions)
  {
    ...
    placeholder: 'e.g., 1) AI task tracking, 2) Progress visualization, 3) Agent integration, 4) Roadmap planning',
    validationType: 'text',
    minLength: 20,
    maxLength: 1000
  },
  ...
  // 1.3 MVP User Stories (3 questions)
  {
    ...
    questionNumber: 1,
    questionText: 'List 5-10 critical user stories for MVP (format: "As a [user], I want to [action] so that [benefit]")',
    placeholder: 'e.g., As a developer, I want to see my current task so that I know what to work on next',
    validationType: 'text',
    minLength: 50,
    maxLength: 2000
  },
  {
    ...
    placeholder: 'e.g., As a developer, I want AI to auto-update task progress so that I never manually track status',
    validationType: 'text',
    minLength: 20,
    maxLength: 500
  },
  ...
  },
  {
    ...
    placeholder: 'e.g., Team collaboration, mobile app, advanced analytics, marketplace integrations',
    validationType: 'text',
    maxLength: 1000
  },
  ...
  // 2.4 Risk Assessment (2 questions)
  {
    ...
    placeholder: 'e.g., AI integration complexity, real-time sync reliability, database performance at scale',
    validationType: 'text',
    minLength: 10,
    maxLength: 1000
  },
  {
    ...
    subsection: '2.4 Risk Assessment',
    questionNumber: 2,
    questionText: 'What dependencies or integrations are critical? (e.g., Stripe, OpenAI, SendGrid)',
    placeholder: 'e.g., OpenAI for AI features, GitHub API for repo integration, Stripe for payments',
    validationType: 'text',
    maxLength: 1000
  },
  ...
  // 3.1 User Flows (3 questions)
  {
    ...
    placeholder: 'e.g., User signs up → Connects repo → AI creates initial roadmap → User starts first task → AI tracks progress',
    validationType: 'text',
    minLength: 20,
    maxLength: 1000
  },
  {
    ...
    placeholder: 'e.g., 3-step wizard: 1) Project setup, 2) Tech stack selection, 3) Initial roadmap generation',
    validationType: 'text',
    minLength: 10,
    maxLength: 1000
  },
  ...
  // 3.2 Wireframes & Layout (3 questions)
  {
    ...
    placeholder: 'e.g., Yes, Figma designs attached. Main layout: sidebar + kanban board + right panel for task details',
    validationType: 'text',
    isRequired: false,
    maxLength: 1000
  },
  {
    ...
    placeholder: 'e.g., Dashboard (main view), Roadmap page, Task detail page, Settings, Onboarding wizard',
    validationType: 'text',
    minLength: 10,
    maxLength: 500
  },
  {
    ...
    subsection: '3.2 Wireframes & Layout',
    questionNumber: 3,
    questionText: 'What design system or component library do you prefer? (shadcn/ui, Material UI, custom)',
    placeholder: 'e.g., shadcn/ui for rapid development, custom neumorphic design for differentiation',
    validationType: 'text',
    minLength: 5,
    maxLength: 200
  },
  ...
  // 3.3 Component Library (3 questions)
  {
    ...
    placeholder: 'e.g., Kanban boards, data tables, forms with validation, modals, charts for analytics',
    validationType: 'text',
    minLength: 10,
    maxLength: 500
  },
  ...
  },
  {
    ...
    placeholder: 'e.g., Project has many Phases (1:N), Phase has many Sprints (1:N), Task belongs to Day (N:1)',
    validationType: 'text',
    minLength: 10,
    maxLength: 1000
  },
  ...
  },
  {
    ...
    placeholder: 'e.g., GET/POST /api/tasks, GET /api/roadmap, POST /api/sessions, GET /api/current-position',
    validationType: 'text',
    minLength: 10,
    maxLength: 1000
  },
  ...
  // 4.4 Caching & Performance (3 questions)
  {
    ...
    questionNumber: 1,
    questionText: 'What performance targets do you have? (e.g., <3s page load, <500ms API response)',
  ...
  },
  {
    ...
    placeholder: 'e.g., Static pages cached (CDN), task updates real-time (WebSocket), roadmap cached (5 min)',
    validationType: 'text',
    maxLength: 1000
  },
  ...
  // 5.3 Monitoring & Observability (3 questions)
  {
    ...
    placeholder: 'e.g., Sentry for error tracking, Vercel Analytics for performance, custom health checks',
    validationType: 'text',
    minLength: 5,
    maxLength: 200
  },
  ...
  // 6.2 Business Logic (3 questions)
  {
    ...
    placeholder: 'e.g., Free users: 1 project, 100 tasks. Pro users: unlimited projects, AI features enabled',
    validationType: 'text',
    minLength: 10,
    maxLength: 1000
  },
  ...
  },
  {
    ...
    placeholder: 'e.g., AI progress updates every 5 min, daily report generation, cleanup old sessions weekly',
    validationType: 'text',
    maxLength: 1000
  },
  ...
  },
  {
    ...
    subsection: '7.2 Data Fetching',
    questionNumber: 2,
    questionText: 'What data needs real-time updates? (notifications, chat messages, collaborative editing)',
  ...
  },
  {
    ...
    placeholder: 'e.g., Vitest for unit tests, Playwright for E2E, React Testing Library for components',
    validationType: 'text',
    minLength: 5,
    maxLength: 200
  },
  ...
  },
  {
    ...
    placeholder: 'e.g., Critical (app broken), High (feature broken), Medium (minor bug), Low (nice to have)',
    validationType: 'text',
    minLength: 10,
    maxLength: 500
  },
  {
    ...
    placeholder: 'e.g., Critical bugs fixed immediately, high/medium in next sprint, low in backlog',
    validationType: 'text',
    minLength: 10,
    maxLength: 500
  },
  ...
  },
  {
    ...
    placeholder: 'e.g., Vercel instant rollback to previous deployment, database backup restore process',
    validationType: 'text',
    minLength: 10,
    maxLength: 500
  },
  ...
  },
  {
    ...
    placeholder: 'e.g., Zod validation, Prisma parameterized queries, React escapes output, CSRF tokens',
    validationType: 'text',
    minLength: 10,
    maxLength: 500
  },
  ...
  },
  {
    ...
    placeholder: 'e.g., Active users indefinite, deleted users purged after 30 days, logs retained 90 days',
    validationType: 'text',
    minLength: 10,
    maxLength: 500
  },
